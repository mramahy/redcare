...
class GitHubSearchServiceTest {
  ...
  void returnsScoredRepositoriesSortedByScore() {
    ...
    var repositories = List.of(
        new GitHubRepository("repo1", "http://repo1", 100L, 10L, now.minusSeconds(3600),
            now.minusSeconds(1800)),
        new GitHubRepository("repo2", "http://repo2", 90L, 5L, now.minusSeconds(7200),
    ...
    var result = gitHubSearchService.searchAndScoreRepositories("java", now.minusSeconds(3600), 1,
        1);
